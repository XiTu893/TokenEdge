export class ModelConfig {
  constructor(
    ...
    public sizeGB: string,
    public sizeBytes: number,
    public minRAMGB: number,
    public recommendedRAMGB: number,
    public contextOptions: number[],
    public defaultContextIndex: number,
    public downloadUrls: string[],
    public description: string
  ) {}
}

export const PC_MODELS: ModelConfig[] = [
  new ModelConfig(
    "gemma-4-e2b",
    "Gemma 4 E2B",
    "Gemma 4 E2B",
...
export function getRecommendedModel(totalRAMGB: number): ModelConfig {
...
export function getMinimalModel(totalRAMGB: number): ModelConfig {
